package org.apache.dfree.app.common.config;
...
@EnableJpaRepositories(
        basePackages = {org.apache.dfree.app.common.config.RepositoryConfig.ReadWrite.REPOSITORY_PACKAGE},
        entityManagerFactoryRef = "rwEntityManagerFactory",
        transactionManagerRef = "rwTransactionManager",
        includeFilters = {@ComponentScan.Filter(type = FilterType.CUSTOM, classes = {org.apache.dfree.app.common.config.RepositoryConfig.ReadWrite.class})}
)
@EnableJpaAuditing
public class ReadWriteJpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(org.springframework.boot.orm.jpa.EntityManagerFactoryBuilder builder,
        ...
        return builder
                ...
                .packages(
                        org.apache.dfree.app.common.config.RepositoryConfig.JPA_ENTITY_HOME
                )
