...
@EnableJpaRepositories(
        basePackages = {org.apache.dfree.app.common.config.RepositoryConfig.ReadOnly.REPOSITORY_PACKAGE},
        entityManagerFactoryRef = "rEntityManagerFactory",
        transactionManagerRef = "rTransactionManager",
        includeFilters = {@ComponentScan.Filter(type = FilterType.CUSTOM, classes = {org.apache.dfree.app.common.config.RepositoryConfig.ReadOnly.class})}
)
